    ...
    return (
        <View style={{ backgroundColor: 'white', flex: 1 }}>
            ...
            <View style={{ alignItems: 'center' }}>
                ...
                < Text style={{ fontFamily: 'roboto', fontWeight: '500', fontSize: 24, color: '#575757', marginTop: 10 }}>Rp 999.999.999</Text>
            </View>
            <View style={{ marginTop: 20, paddingVertical: 20, backgroundColor: '#4982C1', alignItems: 'center', marginHorizontal: 30 }}>
                ...
                < Text style={{ color: 'white', fontFamily: 'roboto', fontWeight: '500', fontSize: 18, marginTop: 10 }}>Receiver: Fauzan Azrial</Text>
                < Text style={{ color: 'white', fontFamily: 'roboto', fontWeight: '500', fontSize: 18, marginTop: 10 }}>08123456789</Text>
            </View>
